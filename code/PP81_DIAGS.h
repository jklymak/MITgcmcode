C $Header: /u/gcmpack/MITgcm/pkg/pp81/PP81_DIAGS.h,v 1.1 2004/09/02 09:11:54 mlosch Exp $
C $Name:  $
...
C----------------------------------------------------------------
      ...
      _RL PPepstave  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      COMMON /PP81_TAVE_DIAGS/  PPviscArtave, PPdiffKrtave, PPepstave
